        ...
        <div class="p-2">
            <div class="input-wrapper">
                ...
                <button
                    ...
                    @click="resetFilter"
                >
                    <icon type="x-circle" view-box="0 0 22 22" width="30" height="30" />
                </button>
            </div>
        </div>
    </div>
    ...
    export default {
        ...
        methods: {
            handleChange: function (value) {
                ...
                var val = Array.isArray(value) && value.length === 2
...
<style>
:is(.dark .form-input.disabled), :is(.dark .form-input:disabled), :is(.dark .form-select:disabled), :is(.dark input.form-input:read-only:not([type=color])), :is(.dark textarea.form-input:read-only) {
